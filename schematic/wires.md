...
| HV terminal blocks (TB1/TB3 +, TB2 −) | 5/16″ and **1/4-20** studs | 2/0 lugs on 5/16″; 10/18 AWG HV on 1/4″ | schematic |
...
SB50 mates top-to-top: charger **+** (left top) → vehicle right top → 32 A 2-pole → TerminalBlock1 **1/4-20** (pack +). Charger **−** (left bottom) → vehicle right bottom → Circuit_Breaker3 → TerminalBlock2 **1/4-20** (pack −).
...
| CH-DC+2 | 10 AWG HV | red | 2Pole_1000V_DC_32Amp1 A | breaker HV terminal | TerminalBlock1 1/4-20 | 1/4″ stud, ring lug | carry TSM2500 red |
...
| CH-DC−2 | 10 AWG HV | black | Circuit_Breaker3 A | breaker HV terminal | TerminalBlock2 1/4-20 | 1/4″ stud, ring lug | carry TSM2500 black |
...
| DC-IN+2 | 10 AWG HV | red | Circuit_Breaker4 B | breaker HV terminal | TerminalBlock1 1/4-20 | 1/4″ stud | vehicle HV+ |
| DC-IN− | 10 AWG HV | black | dj70310-6.3-1 right mid | 6.3 mm contact | 2Pole_1000V_DC_10Amp1 A | breaker HV terminal | vehicle HV− |
| DC-IN−2 | 10 AWG HV | black | 2Pole_1000V_DC_10Amp1 B | breaker HV terminal | TerminalBlock2 1/4-20 | 1/4″ stud | vehicle HV− |
...
| ID | Size / type | Color | End A | A termination | End B | B termination |
| --- | --- | --- | --- | --- | --- | --- |
| PC-01 | 18 AWG HV (unlabeled) | red | TerminalBlock3 1/4-20 | 1/4″ stud | Circuit_Breaker2 | breaker HV terminal |
...
Parsed `IH53EV.kicad_sch` after the terminal-block symbol change (**1/4″ studs**, `Terminal_Block+` / `Terminal_Block−`). Gaps left as documented:
...
- Unused: Blue Sea circuits 1, 3 and unused 6, Orion fan pins 9/10, Tesla cell-tap pins, one TerminalBlock3 **1/4-20** stud, USBConnector1 stub.
- RPi 5 + PiCAN 3 at the dash. SW5 **Instruments** feeds them from Always_Hot **Dash/Pi**. Ready/Precharge is not gated.
- HV junction studs: schematic `Terminal_Block+` / `Terminal_Block−` now read **1/4″ studs** plus **5/16″ studs**. TB1 and TB3 are the + symbol; TB2 is the − symbol.
